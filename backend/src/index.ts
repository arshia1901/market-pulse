...
app.listen(PORT, () => {
  console.log(`🚀 Market Watchlist Backend running on http://localhost:${PORT}`);
  console.log(`📊 Demo mode: enabled (pass 'Authorization: Bearer YOUR_TOKEN' to use real Groww API)`);
});
